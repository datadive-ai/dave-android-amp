    ...
    private class CachedInfo {
        ...
        private String getAndCacheGoogleAdvertisingId() {
            try {
                ...
                DatadiveLog.getLogger().w(TAG, "Google Play Services SDK not found!");
            } catch (InvocationTargetException e) {
                DatadiveLog.getLogger().w(TAG, "Google Play Services not available");
            } catch (Exception e) {
                DatadiveLog.getLogger().e(TAG, "Encountered an error connecting to Google Play Services", e);
            }
        ...
        private boolean checkGPSEnabled() {
            ...
            try {
                ...
                DatadiveLog.getLogger().w(TAG, "Google Play Services Util not found!");
            } catch (ClassNotFoundException e) {
                DatadiveLog.getLogger().w(TAG, "Google Play Services Util not found!");
    ...
    public Location getMostRecentLocation() {
        ...
        for (String provider : providers) {
            ...
            try {
                ...
                DatadiveLog.getLogger().w(TAG, "Failed to get most recent location");
            } catch (Exception e) {
                DatadiveLog.getLogger().w(TAG, "Failed to get most recent location");
            }
            if (location != null) {
