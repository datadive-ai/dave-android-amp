...
public class DatadiveLog {
    private volatile boolean enableLogging = true;
    private volatile int logLevel = Log.INFO; // default log level

    protected static DatadiveLog instance = new DatadiveLog();

    public static DatadiveLog getLogger() {
        return instance;
    }

    private DatadiveLog() {} // prevent instantiation

    DatadiveLog setEnableLogging(boolean enableLogging) {
        this.enableLogging = enableLogging;
        return instance;
    }

    DatadiveLog setLogLevel(int logLevel) {
