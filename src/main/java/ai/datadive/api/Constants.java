...
import ai.datadive.BuildConfig;

public class Constants {

    public static final String LIBRARY = "datadive-android";
    public static final String VERSION = BuildConfig.DATADIVE_VERSION;
    ...
    public static final String EVENT_LOG_URL = "https://source.datadive.ai/event/";
    public static final String DYNAMIC_CONFIG_URL = "https://regionconfig.datadive.ai/";

    public static final String PACKAGE_NAME = "ai.datadive.api";
