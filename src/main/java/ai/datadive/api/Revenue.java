 ...
 * in conjunction with {@code DatadiveClient.logRevenueV2()} to record in-app transactions.
 ...
 * Datadive servers by calling {@code Datadive.getInstance().logRevenueV2(revenue);} and pass in
 * the object.
 *
...
public class Revenue {
    ...
    /**
     * Converts Revenue object into a JSONObject to send to Datadive servers
     *
