...
/**
 * <h1>Datadive</h1>
 * This is the main Datadive class that manages SDK instances. <br><br>
 * <b>NOTE:</b> All of the methods except {@code getInstance()} have been deprecated.
 * Please call those methods on the DatadiveClient instance instead, for example:
 * {@code Datadive.getInstance().logEvent();}
 *
 * @see DatadiveClient DatadiveClient
 */
public class Datadive {

    static final Map<String, DatadiveClient> instances = new HashMap<String, DatadiveClient>();
     ...
     */
    public static DatadiveClient getInstance() {
     ...
     */
    public static synchronized DatadiveClient getInstance(String instance) {
        instance = Utils.normalizeInstanceName(instance);
        DatadiveClient client = instances.get(instance);
        if (client == null) {
            client = new DatadiveClient(instance);
    ...
    /**
     * Initialize the SDK with the Android app context and Datadive API key.
    ...
    /**
     * Initialize the SDK with the Android app context, Datadive API key, and a user Id.
     * Initializing is required before calling other methods such as {@code logEvent();}.
     *
     * @param context the context
     * @param apiKey  the api key
