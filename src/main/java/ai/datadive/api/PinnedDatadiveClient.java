...
/**
 * <h1>PinnedDatadiveClient</h1>
 * This is a version of the DatadiveClient that supports SSL pinning for encrypted requests.
 * Please contact <a href="mailto:support@xsight.in">Datadive Support</a> before you ship any
 * products with SSL pinning enabled so that we are aware and can provide documentation
 * and implementation help.
 */
public class PinnedDatadiveClient extends DatadiveClient {

    /**
     * The class identifier tag used in logging. TAG = {@code "PinnedDatadiveClient";}
     */
    private static final String TAG = PinnedDatadiveClient.class.getName();
    ...
    /**
     * Pinned certificate chain for api.datadive.com.
     */
    protected static final SSLContextBuilder SSL_CONTEXT_API_DATADIVE_COM =
    ...
    static Map<String, PinnedDatadiveClient> instances = new HashMap<String, PinnedDatadiveClient>();
     ...
     */
    public static PinnedDatadiveClient getInstance() {
     ...
     */
    public static synchronized PinnedDatadiveClient getInstance(String instance) {
        instance = Utils.normalizeInstanceName(instance);
        PinnedDatadiveClient client = instances.get(instance);
        if (client == null) {
            client = new PinnedDatadiveClient(instance);
    ...
    /**
     * Instantiates a new Pinned datadive client.
     */
    public PinnedDatadiveClient(String instance) {
        super(instance);
    }
    ...
    @Override
    public synchronized DatadiveClient initialize(Context context, String apiKey, String userId) {
        super.initialize(context, apiKey, userId);
        final PinnedDatadiveClient client = this;
    ...
    protected SSLSocketFactory getPinnedCertSslSocketFactory() {
        return getPinnedCertSslSocketFactory(SSL_CONTEXT_API_DATADIVE_COM);
    }
